...
The variable `user_command` contains your text from the input field.
...
* Then the code could be:
        ...
        else if user_command = kor ; Translate English to Korean
        {
...
Example:
    ...
    else if user_command = y%A_Space% ; Search Youtube
    {
